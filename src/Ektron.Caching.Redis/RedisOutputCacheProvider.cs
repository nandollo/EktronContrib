...
using Ektron.Caching.Common;
using Ektron.Caching.Common.Configuration;

namespace Ektron.Caching.Redis
{
	public class RedisOutputCacheProvider : OutputCacheProvider
	{
		...
		public override object Get(string key)
		{
			...
			var hostElement = _slaves.First();

			var host = hostElement.Host;
			var port = hostElement.Port;
			var password = hostElement.Password;
